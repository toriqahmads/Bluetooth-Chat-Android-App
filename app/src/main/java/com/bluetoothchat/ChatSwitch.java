...
public class ChatSwitch {
    private static final String APP_NAME = "Chat Bluetooth";
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("toast", "Tidak dapat terhubung ke perangkat");
        msg.setData(bundle);
        handler.sendMessage(msg);
    ...
    private void connectionLost() {
        Message msg = handler.obtainMessage(MainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString("toast", "Koneksi ke perangkat terputus");
        msg.setData(bundle);
        handler.sendMessage(msg);
